...
public class YanlisDegerException extends GunException{ //GunException sınıfından miras aldığımız için ve GunException sınıfı da Exception sınıfından miras aldığı için dolaylı olarak YanlisDegerException'da Exception sınıfından miras alıyor ve Checked Exception oluyor.
	...
	public YanlisDegerException(String mesaj) {
		super(mesaj);
	}
